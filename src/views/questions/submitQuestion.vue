...
export default {
  ...
  methods: {
    shareToQZone() {
      window.open(
        "https://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=www.schoolrush.top/qustion/" +
          this.id,
        "_blank"
      );
    },
    shareToWB() {
      window.open(
        "http://service.weibo.com/share/share.php?appkey=1881139527&url=https://www.schoolrush.top/qustion/" +
          this.id +
          "&title=" +
          this.title,
        "_blank"
    ...
    shareToDB() {
      window.open(
        "https://www.douban.com/share/service?name=" +
          this.title +
          "&url=www.schoolrush.top/qustion/" +
          this.id,
        "_blank"
      );
    },
