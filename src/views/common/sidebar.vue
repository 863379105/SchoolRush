    ...
    <div class="sidebar-item sidebar-userinfo-container">
          ...
          <div class="sidebar-item sidebar-fastto-container">
              <ul class="fastto">
                ...
                <li><p><Icon type="checkmark-circled"></Icon><router-link to="/solvedQuestion">已通过</router-link></p></li>
                <li><p><Icon type="hammer"></Icon><router-link to="/solvingQuestion">正在解决</router-link></p></li>
